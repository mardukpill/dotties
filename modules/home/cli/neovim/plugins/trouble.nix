{ config, lib, ... }:
# https://github.com/khaneliman/khanelivim/blob/64ee7849fb9b7662465388c0df694e0be368ce36/packages/khanelivim/plugins/trouble.nix
let
...
in
{
  programs.nixvim = {
    plugins = {
      ...
      which-key.settings.spec = lib.optionals cfg.plugins.trouble.enable [
        {
          __unkeyed = "<leader>x";
          mode = "n";
          icon = "";
    ...
    keymaps = lib.mkIf cfg.plugins.trouble.enable [
      {
        mode = "n";
        key = "<leader>xx";
