  ...
  config = mkIf (cfg.theme == "acrylic") {
    wayland.windowManager.hyprland = {
      settings = {
        ...
        "general:col.active_border" = "rgba(${config.colorScheme.palette.base04}FF)";
        "general:col.inactive_border" = "rgba(${config.colorScheme.palette.base07}FF)";
