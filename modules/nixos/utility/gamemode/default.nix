{
  # https://github.com/khaneliman/khanelinix/blob/4f69318cd30fb1c78e1c81dc6d33c45300f7d661/modules/nixos/programs/graphical/addons/gamemode/default.nix
  config,
  lib,
  pkgs,
  namespace,
...
let
  ...
  cfg = config.${namespace}.utility.gamemode;
...
in
{
  options.${namespace}.utility.gamemode = with types; {
